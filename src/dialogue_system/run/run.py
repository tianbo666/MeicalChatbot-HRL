...
import json
import torch
sys.path.append(os.getcwd().replace("C:\Users\ttb\Downloads\acl2018-mds.zip\acl2018-mds",""))
...
parser.add_argument("--saved_model", dest="saved_model", type=str, default="./../../model/DQN/checkpoint/0220173244_AgentWithGoal_T22_lr0.0001_RFS44_RFF-22_RFNCY-1_RFIRS-1_mls0_gamma0.95_gammaW0.95_epsilon0.1_awd0_crs0_hwg0_wc0_var0_sdai0_wfrs0.0_dtft1_dataReal_World_RID3_DQN/model_d10agentAgentWithGoal_s0.993_r41.658_t6.799_wd0.0_e-822.pkl")
